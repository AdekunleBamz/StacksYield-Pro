      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <a
              href="#how-it-works"
              className="btn-secondary px-8 py-4 rounded-2xl font-semibold text-lg w-full sm:w-auto text-center focus:outline-none focus:ring-2 focus:ring-stacks-purple/50"
            >
              How It Works
            </a>
          </div>
