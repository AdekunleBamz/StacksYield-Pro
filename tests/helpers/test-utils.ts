...
export const ERROR_CODES = {
    ...
    VAULT_NOT_FOUND: 1004,
    VAULT_PAUSED: 1005,
    WITHDRAWAL_LOCKED: 1006,
    INVALID_STRATEGY: 1007,
    REFERRAL_SELF: 1008,
    ALREADY_REGISTERED: 1009,
    INVALID_SHARES: 1010,
    NOT_REGISTERED: 1011,
    NO_PENDING_ADMIN_ACTION: 1012,
    TIMELOCK_NOT_READY: 1013,
    NO_SHARES: 1014,
    LOCK_PERIOD_ACTIVE: 1015,
    ACTION_ALREADY_PENDING: 1016,
    INVALID_APY: 1017,
    NO_REWARDS: 1018,
};
